...
class BuildSecrets extends command_1.Command {
    async run() {
        ...
        const secretsMap = require(path_1.join(process.cwd(), flags.mapfile));
...
BuildSecrets.flags = {
    ...
    mapfile: command_1.flags.string({ char: 'm', description: 'path to secrets-map.json file', default: './secrets-map.json' })
};
